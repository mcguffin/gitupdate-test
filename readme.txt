...
You can can either go into the Support forum, or in the [GitUpdate Test Repository](https://github.com/mcguffin/gitupdate-test).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com/mcguffin/gitupdate-test)
(See above as well.)
...
3. type `git clone git@github.com:mcguffin/gitupdate-test.git`
...
Either post it on the [GitHub-repo](https://github.com/mcguffin/gitupdate-test) or—if you cloned the repository—send me a pull request.
