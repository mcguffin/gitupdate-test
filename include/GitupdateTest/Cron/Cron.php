...
//		add_action('init',array( $this, 'init' ) );
		...
		add_option( 'gitupdate_test_cronjobs', array() );
		add_option( 'gitupdate_test_cronschedules', array() );
	...
	private function init() {
		$this->jobs = get_option( 'gitupdate_test_cronjobs' );
	...
	public function get_schedule( $interval ) {
		...
		if ( ! $schedule = $this->find_schedule( $interval ) ) {
			...
			update_option( 'gitupdate_test_cronschedules', $schedules );
		}
		return $schedule;
	}
	...
	public function cron_schedules( $schedules ) {
		return $schedules + get_option('gitupdate_test_cronschedules');
	}
	...
	private function update() {
		...
		update_option( 'gitupdate_test_cronjobs', $this->jobs );
	...
	public function deactivate() {
		// stop all jobs
		$jobs = get_option( 'gitupdate_test_cronjobs', $this->jobs );
	...
	public function uninstall() {
		...
		delete_option( 'gitupdate_test_cronjobs' );
		delete_option( 'gitupdate_test_cronschedules' );
